...
export default function TaskDetail() {
  ...
  // ✅ BULLETPROOF "CLONE AND CAPTURE" PDF EXPORT
  const handleExportPDF = async () => {
    ...
    // 2. Force the clone to be perfectly visible and on top of everything
    ...
    // 4. Wait for the browser to paint the clone and load fonts
    ...
    try {
      ...
      // 5. Clean up: instantly remove the clone from the DOM
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
      ...
      {/* ✅ HIDDEN CONTAINER FOR PDF CLONING */}
      <div 
        id="task-full-report" 
